...
let INPUT_FILE = '';
let INPUT_URL = 'https://www.southdakotasoccer.com/clubs/club-directory/';
let OUTPUT_FILE = 'data/output/southdakotasoccer-urls.csv';
let csvRecords = [57701, 57401, 57103];
...
exports.southdakotasoccer = async (req, res, next) => {
    try {
