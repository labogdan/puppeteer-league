...
let INPUT_FILE = 'data/output/nahl-urls.csv';
let INPUT_URL = '';
let OUTPUT_FILE = 'data/output/nahl-final.csv';
let csvRecords = [];
...
exports.nahlfinal = async (socket) => {
    try {
        console.log('nahl-final');
        socket.send('inside soccer controller (nahl-final)');
