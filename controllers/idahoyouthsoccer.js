...
let INPUT_FILE = '';
let INPUT_URL = 'https://www.idahoyouthsoccer.org/clubs/club-directory/';
let OUTPUT_FILE = 'data/output/idahoyouthsoccer-urls.csv';
...
exports.idahoyouthsoccer = async (req, res, next) => {
    try {
