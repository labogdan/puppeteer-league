...
async function scrapePageForOrgInfo(page, previousData) {
  ...
  let ids = await page.evaluate(() => {
    ...
    //data.push(utils.getParameterByName('orgid', document.location.href));
    //data.push(utils.getParameterByName('orgteamid', document.location.href));
    //data.push(utils.getParameterByName('team', document.location.href));
