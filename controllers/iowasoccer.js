...
let INPUT_FILE = '';
let INPUT_URL = 'https://www.iowasoccer.org/about/find-a-youth-club-or-adult-league/';
let OUTPUT_FILE = 'data/output/iowasoccer-urls.csv';
let csvRecords = [50301, 52401, 50010, 50701, 51501];
...
exports.iowasoccer = async (req, res, next) => {
    try {
        console.log('iowasoccer');
        await init();
        res.send({msg: 'ok'});
      } catch (error) {
        console.error('there was an error');
