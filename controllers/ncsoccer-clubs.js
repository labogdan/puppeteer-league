...
let INPUT_FILE = 'data/output/ncsoccer-urls.csv';
let INPUT_URL = '';
let OUTPUT_FILE = 'data/output/ncsoccer-clubs.csv';
let csvRecords = [];
...
exports.ncsoccerclubs = async (socket) => {
    try {
        console.log('ncsoccerclubs');
        socket.send('inside soccer controller (ncsoccerclubs)');
        await init(socket);
