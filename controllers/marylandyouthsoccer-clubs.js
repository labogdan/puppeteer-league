...
let INPUT_FILE = 'data/output/marylandyouthsoccer-urls.csv';
let INPUT_URL = '';
let OUTPUT_FILE = 'data/output/marylandyouthsoccer-clubs.csv';
let csvRecords = [];
...
exports.marylandyouthsoccerclubs = async (socket) => {
    try {
        console.log('marylandyouthsoccerclubs');
        socket.send('inside soccer controller (marylandyouthsoccerclubs)');
        await init(socket);
