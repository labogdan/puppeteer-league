...
let INPUT_FILE = '';
let INPUT_URL = 'https://www.fysa.com/clubs/club-directory/';
let OUTPUT_FILE = 'data/output/floridayouthsoccer-urls.csv';
let csvRecords = [33101, 33901, 33592, 32789, 32034, 32301];
...
exports.floridayouthsoccer = async (socket, message) => {
  try {
    console.log('floridayouthsoccer');
    socket.send('inside soccer controller (floridayouthsoccer)');
